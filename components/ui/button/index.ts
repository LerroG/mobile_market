  ...
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-0 focus-visible:ring-ring focus-visible:ring-offset-0 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        outline:
          'border border-input bg-background hover:bg-accent hover:text-accent-foreground active:bg-accent-foreground/10',
        secondary:
          'bg-secondary/40 text-secondary-foreground hover:bg-secondary/80 active:bg-secondary',
        ghost: 'hover:bg-accent hover:text-accent-foreground active:bg-accent-foreground/10',
